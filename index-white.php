...
$p=mysql_query("select count(V)as Punkty from  reversi where V=1; "); $p2= mysql_result($p,0,0);
...
{
echo'
<form action="gra-w.php" method="post">
X<br />
...
<meta http-equiv="refresh" content="7;url=index-white.php" />
</body>
</html>
